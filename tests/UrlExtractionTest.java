...
class UrlExtractionTest {
    ...
    void testMarkdownLinkInline(){
        ...
        PostVersionList a_33 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 33, Posts.ANSWER_ID);
        ...
        PostVersionList q_37625877 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 37625877, Posts.QUESTION_ID);
    ...
    void testMarkdownLinkReference(){
         ...
         */
        PostVersionList a_44 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 44, Posts.ANSWER_ID);
    ...
    void testAnchorLink(){
        ...
        PostVersionList a_1629423 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 1629423, Posts.ANSWER_ID);
    ...
    void testMarkdownLinkAngleBrackets(){
        ...
        PostVersionList a_52 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 52, Posts.ANSWER_ID);
    ...
    void testBareLink(){
        ...
        PostVersionList a_49 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 49, Posts.ANSWER_ID);
    ...
    void testDeletionOfEmptyTextBlocksAfterNormalization () {
        ...
        PostVersionList a_19049539 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 19049539, Posts.ANSWER_ID);
    ...
    void testLinkTypeAndAnchorExtraction() {
        ...
        // AnchorLink
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 1629423, Posts.ANSWER_ID);
        ...
        // BareLink
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 49, Posts.ANSWER_ID);
        extractedLink = Link.extractTyped(postVersionList.getFirst().getContent()).get(0);
        ...
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 52, Posts.ANSWER_ID);
        extractedLink = Link.extractTyped(postVersionList.getFirst().getContent()).get(0);
        ...
        // MarkdownLinkInline
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 33, Posts.ANSWER_ID);
        extractedLink = Link.extractTyped(postVersionList.getFirst().getContent()).get(0);
        ...
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 44, Posts.ANSWER_ID);
        extractedLink = Link.extractTyped(postVersionList.getFirst().getContent()).get(0);
    ...
    void testLinkPosition() {
        ...
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 12954660, Posts.QUESTION_ID);
        ...
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 28153330, Posts.ANSWER_ID);
        version = postVersionList.getLast();
        extractedLink = Link.extractTyped(version.getContent()).get(0);
        assertEquals("End", extractedLink.getPosition(version.getContent()));

        // link in the middle of a post
        postVersionList = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 14928352, Posts.ANSWER_ID);
        version = postVersionList.getLast();
    ...
    void testExcludeLinksInInlineCode() {
        ...
        /*  ...
            ...
            ...
         */
        PostVersionList a_38542344 = PostVersionList.readFromCSV(TestUtils.pathToPostVersionLists, 38542344, Posts.ANSWER_ID);
